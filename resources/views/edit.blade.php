    ...
    <div class=" bg-white shadow-lg rounded-lg overflow-hidden max-w-2xl mx-auto">
        ...
        <div class="p-8">
            <form action="{{ route('products.update', $product->id) }}" method="POST" class="space-y-6">
                ...
                <button type="submit"
                    class="w-full bg-green-600 text-white font-semibold py-3 px-6 rounded-lg shadow hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2">
                    Update Product
                </button>
            </form>
